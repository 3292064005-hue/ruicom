...
class FakeVendorChassisDevice:
    def __init__(self):
        rospy.init_node('fake_vendor_chassis_device', anonymous=False)
        ...
        self.sub = rospy.Subscriber(self.input_topic, Twist, self._cb, queue_size=20)
