...
class ManagedSceneImagePublisher:
    def __init__(self):
        rospy.init_node('managed_scene_image_publisher', anonymous=False)
    ...
    def _build_frame(width: int, height: int):
        ...
        cv2.putText(image, 'Managed Recon Scene', (20, height - 20), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (32,32,32), 2, cv2.LINE_AA)
...
if __name__ == '__main__':
    ManagedSceneImagePublisher().spin()
